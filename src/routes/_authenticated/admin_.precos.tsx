...
export const Route = createFileRoute("/_authenticated/admin_/precos")({
  head: () => ({
    meta: [
      { title: "Preços do Vitrini PRO | Vitrini" },
      {
        name: "description",
        content: "Atualize o preço e as promoções temporárias do Vitrini PRO.",
      },
      ...
      <section className="surface space-y-4 p-5">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            A alteração vale para novos checkouts e para o Pix PRO.
          </p>
        </div>
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="flex items-center gap-2 pt-6">
            <Switch
              ...
              onCheckedChange={(checked) => setForm({ ...form, promoActive: checked })}
            />
        ...
        <div className="rounded-lg border border-dashed p-3 text-sm text-muted-foreground">
          Preço vigente agora:{" "}
          <strong className="text-foreground">{brl(publicPricing.price)}/mês</strong>
        </div>
        <Button
